...
<section class="panel col-30">
	...
	<section class="panel-body">
		<section class="panel-body-content">
			<form action="?m=settings&section=new_account" method="post" id="new_account">
	...
	<section class="panel-footer">
		<section class="panel-footer-content">
			<button class="btn btn-submit" onclick="document.forms['new_account'].submit()">Ajouter</button>
